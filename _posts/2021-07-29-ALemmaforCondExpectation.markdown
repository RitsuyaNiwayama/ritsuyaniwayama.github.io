...
$$\lvert E[Z_nX\mid \mathcal{G}]\rvert \leq E[\lvert Z_nX\rvert \mid \mathcal{G}]$$. Then,$$E[E[\lvert Z_nX\rvert \mid \mathcal{G}]=E[\lvert Z_nX\rvert] \lt \infty$$.Therefore, $$\lim_{n \to +\infty}E[Z_nE[X\mid \mathcal{G}]:A]=E[ZE[X\mid \mathcal{G}]:A]$$
